...
urlpatterns += [path("apis/<contenttype:contenttype>/topics", views.AnnotationTopicsView.as_view(), name="annotationstopicsview")]
urlpatterns += [path("apis/<contenttype:contenttype>/depicted", views.AnnotationDepictedView.as_view(), name="annotationsdepictedview")]
