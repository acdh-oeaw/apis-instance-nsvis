...
document.querySelectorAll("details").forEach(details => {
    details.addEventListener("click", function() { detailsToggleEventListener(details) });
});
...
canvas.addEventListener('mouseup', () => {
    ...
    if (r.area() > 1000) {
      ...
      emptyForm.addEventListener("click", function() { detailsToggleEventListener(emptyForm) });
